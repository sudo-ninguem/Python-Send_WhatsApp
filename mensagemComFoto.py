...
# -*- coding: utf-8 -*-
"""
Created on Thu May 27 10:27:26 2021
...
contatos = ['contato1', 'contato2', 'Raissa', 'Karina', 'Coordenadora Marketing', '+55 31 1111-1111'] # é possivel mandar para um número direto desde que ele já tenha iniciado uma conversa com o contato
...
midia = "/home/hobbit/Imagens/voce consegue.png"
...
def enviar_midia(midia):
   ...
   ## send = driver.find_element_by_xpath("//div[contains(@class, '_3Git-')]")
    send = driver.find_element_by_xpath("//*[@id='app']/div[1]/div[1]/div[2]/div[2]/span/div[1]/span/div[1]/div/div[2]/span/div/div") ## caminho do Xpath
    send.click()    
